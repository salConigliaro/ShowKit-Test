...
#import <ShowKit/SHKEncoder.h>
#import <ShowKit/SHKStats.h>
 ...
 *
 */
+ (BOOL) sendData:(unsigned char*)message length:(int)length;
 ...
 *
 */
+ (BOOL) sendCommand: (NSData*) data  __attribute__ ((deprecated));;
+ (BOOL) sendText: (NSData*) data;
...
/*!
 *
 *  Set an audio playback gain.
 *
 *  @param integer value for playback gain, 0 to 15.
 *
 */
+ (void) setPlaybackGain:(int) gain;

/*!
 *
 *  Set an audio playback volume.
 *
 *  @param integer value for playback volume, 0 to 100.
 *
 */
...
/*!
 *
 *  Set an audio capture gain.
 *
 *  @param integer value for capture gain, 0 to 15.
 *
 */
+ (void) setCaptureGain:(int) gain;

/*!
 *
 *  Set an audio capture volume.
 *
 *  @param integer value for capture volume, 0 to 100.
 *
 */
...
/*!
 *
 *  Set an audio mute value.
 *
 *  @param integer value for mute, 0 or 1.
 *
 */
